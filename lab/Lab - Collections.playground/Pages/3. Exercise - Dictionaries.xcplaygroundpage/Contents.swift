 ...
 */
var daysPerMonth = ["January": 31, "February": 28, "March": 31]
print(daysPerMonth)
 ...
 */
if let firstMonthsDays = daysPerMonth["January"] {
    print("January has \(firstMonthsDays) days")
}
 ...
 */
if let lastElement = colorsAndShapes[colorsArray.last!]{
    print(lastElement)
}
