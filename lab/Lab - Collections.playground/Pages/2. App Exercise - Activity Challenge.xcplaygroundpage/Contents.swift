 ...
 */
var walkingChallenges: [String] = ["Walk for 20 minutes", "Walk 2 kilometers"]
var runningChallenges: [String] = ["Run fast", "Run for your life"]
...
if committedChallenges.count == 0 {
    ...
    print("You have selected multiple challenges")
}
