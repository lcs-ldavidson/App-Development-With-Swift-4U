...
struct User {
    ...
    static var currentUser = User(userName: "Liam Davidson", email: "something@email.org", age: 17)
    
    static func logIn(user: User) {
        self.currentUser = user
        print("\(currentUser.userName) has successfully logged in")
    }
}
 ...
 */
var me = User(userName: "xXDarkLordWeedMaster69Xx", email: "liam@ginger.ca", age: 76)
User.logIn(user: me)
