...
print("On my first run, I managed to make it \(firstRun.distance) meters up a mountain that was \(firstRun.elevation) meters high in only \(firstRun.time) minutes!")
